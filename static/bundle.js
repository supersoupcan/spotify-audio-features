...
exports.round = round;
exports.splitArrIntoLengths = splitArrIntoLengths;
exports.ellipses = ellipses;
exports.audioFeatureSort = audioFeatureSort;
...
function splitArrIntoLengths(arr, length) {
  var splitedArr = [];
  var calls = Math.floor(arr.length / length);
...
function audioFeatureSort(clone, target) {
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(13), __webpack_require__(70)(module)))
...
exports.default = (0, _redux.createStore)((0, _redux.combineReducers)({ authenticated: _reducers.authenticated, artist: _reducers.artist, tracks: _reducers.tracks, filter: _reducers.filter }), {
  filter: {
    sortBy: "ALBUM",
    reverse: false
  },
...
exports.tracks = exports.filter = exports.artist = exports.authenticated = undefined;
...
var tracks = exports.tracks = function tracks() {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];
  var action = arguments[1];
  ...
  switch (action.type) {
    case "SET_TRACKS":
      {
        var albums = action.payload.albums;
        var trackData = [];
        albums.forEach(function (album) {
          ...
          var albumTrackData = album.tracks.items.map(function (track) {
            return {
              album: albumData,
              id: track.id,
              name: track.name,
    ...
    case "SET_TRACK_AUDIO_FEATURES":
      {
        var startIndex = action.payload.index * 100;
        var endIndex = startIndex + action.payload.audio_features.length;

        var addAudioFeatures = [].concat(_toConsumableArray(state.slice(startIndex, endIndex))).map(function (track, index) {
          return Object.assign(track, { audio_features: action.payload.audio_features[index] });
        });

        state = [].concat(_toConsumableArray(state.slice(0, startIndex)), _toConsumableArray(addAudioFeatures), _toConsumableArray(state.slice(endIndex)));
        break;
      }
    case "SET_FILTER":
      {
        var clone = Object.create(state);
        switch (action.payload) {
          case "ALBUM":
            {
              state = clone.sort(function (a, b) {
                var dateDifference = new Date(a.album.release_date).getTime() - new Date(b.album.release_date).getTime();

                if (dateDifference === 0) {
                  var trackDifference = a.track_number - b.track_number;
          ...
          default:
            {
              state = (0, _methods.audioFeatureSort)(clone, action.payload.toLowerCase());
              break;
            }
        }
        break;
...
var _authenticated = __webpack_require__(105);
...
var _stateless = __webpack_require__(112);
  ...
  _createClass(App, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        'div',
        null,
        !this.props.authenticated && _react2.default.createElement(_stateless.SignIn, null),
        this.props.authenticated && _react2.default.createElement(_Search2.default, {
          getArtistTrackFeatures: this.props.getArtistTrackFeatures
        }),
        this.props.artist && _react2.default.createElement(_stateless.ArtistTitle, {
          artist: this.props.artist
        }),
        this.props.tracks.length > 0 && _react2.default.createElement(_List2.default, {
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    authenticate: function authenticate() {
      dispatch((0, _authenticated.authenticate)());
    },
    getArtistTrackFeatures: function getArtistTrackFeatures(type, keyword) {
      dispatch((0, _api.getArtistTrackFeatures)(type, keyword));
    },
    setFilter: function setFilter(sortBy) {
      dispatch((0, _filter.setFilter)(sortBy));
    }
  };
};
...
function authenticate() {
  return function (dispatch) {
    _axios2.default.get('/auth').catch(function (err) {
      if (err) throw err;
    }).then(function (res) {
      if (res.data.authenticated) {
        ...
        var expires = new Date(res.data.expiration).getTime();
        var timeTillExpiration = expires - now;
...
exports.getArtistTrackFeatures = getArtistTrackFeatures;
...
function getArtistTrackFeatures(type, keyword) {
  return function (dispatch) {
    _axios2.default.request({
      ...
      _axios2.default.request({
        ...
        //TODO: work around limits by sending multiple requests
        var albumIds = res.data.items.map(function (item) {
          return item.id;
        }).toString();
        _axios2.default.request({
          url: '/api/albums',
          ...
          res.data.albums.forEach(function (album) {
            var albumTrackIds = album.tracks.items.map(function (track) {
              return track.id;
            });
            trackIds = trackIds.concat(albumTrackIds);
          });
          var limitedTrackIds = (0, _methods.splitArrIntoLengths)(trackIds, 100);
          limitedTrackIds.forEach(function (trackIds, index) {
            _axios2.default.request({
...
var SongAnalyser = function (_Component) {
  _inherits(SongAnalyser, _Component);

  function SongAnalyser(props) {
    _classCallCheck(this, SongAnalyser);

    var _this = _possibleConstructorReturn(this, (SongAnalyser.__proto__ || Object.getPrototypeOf(SongAnalyser)).call(this, props));
  ...
  _createClass(List, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { className: _List2.default.flexContainerLabel },
          _react2.default.createElement(
            'div',
            { className: _List2.default.trackLabel },
            'Track'
          ),
          _react2.default.createElement(
            'div',
            {
              ...
              onClick: function onClick() {
                return _this2.props.setFilter("ALBUM");
              }
            },
            'Album'
          ),
          _react2.default.createElement(
            'div',
            {
              className: _List2.default.featureLabel,
              style: this.props.filter.sortBy === "ACOUSTICNESS" ? { color: 'red' } : {},
              onClick: function onClick() {
                return _this2.props.setFilter("ACOUSTICNESS");
              }
            },
            'Acousticness'
          ),
          _react2.default.createElement(
            'div',
            {
              ...
              onClick: function onClick() {
                return _this2.props.setFilter("INSTRUMENTALNESS");
              }
            },
            'Instrumentalness'
          ),
          _react2.default.createElement(
            'div',
            {
              ...
              onClick: function onClick() {
                return _this2.props.setFilter("DANCEABILITY");
              }
            },
            'Danceability'
          ),
          _react2.default.createElement(
            'div',
            {
              ...
              onClick: function onClick() {
                return _this2.props.setFilter("ENERGY");
              }
            },
            'Energy'
          ),
          _react2.default.createElement(
            'div',
            {
              ...
              onClick: function onClick() {
                return _this2.props.setFilter("VALENCE");
              }
            },
            'Valance'
          )
...
var Track = function Track(props) {
  ...
  var hasAudioFeatures = track.hasOwnProperty('audio_features');
  var features = track.audio_features;
  return _react2.default.createElement(
    'div',
    { className: _List2.default.flexContainer },
    _react2.default.createElement(
      'div',
      { className: _List2.default.track },
      (0, _methods.ellipses)(track.name, 25)
    ),
    _react2.default.createElement(
      'div',
      { className: _List2.default.track },
      (0, _methods.ellipses)(track.album.name, 25)
    ),
    _react2.default.createElement(
      'div',
      { className: _List2.default.feature },
      hasAudioFeatures ? (0, _methods.round)(features.acousticness * 10, 3) : ""
    ),
    _react2.default.createElement(
      'div',
      { className: _List2.default.feature },
      hasAudioFeatures ? (0, _methods.round)(features.instrumentalness * 10, 3) : ""
    ),
    _react2.default.createElement(
      'div',
      { className: _List2.default.feature },
      hasAudioFeatures ? (0, _methods.round)(features.danceability * 10, 3) : ""
    ),
    _react2.default.createElement(
      'div',
      { className: _List2.default.feature },
      hasAudioFeatures ? (0, _methods.round)(features.energy * 10, 3) : ""
    ),
    _react2.default.createElement(
      'div',
      { className: _List2.default.feature },
      hasAudioFeatures ? (0, _methods.round)(features.valence * 10, 3) : ""
    )
  );
};
...
if(false) {
	module.hot.accept("!!../../node_modules/css-loader/index.js??ref--1-1!./List.css", function() {
		var newContent = require("!!../../node_modules/css-loader/index.js??ref--1-1!./List.css");
...
// module
exports.push([module.i, "._393qTOzdYL2xqGd_cghxEY{\n  margin : 10px;\n  padding : 10px;\n}\n\n._3PUCRnSTaysfmk-3yWBWQi{\n  display : flex;\n  justify-content: space-between;\n}\n\n._2bWn3dC-FrkuDl4pw98GvI{\n  border-bottom : 1px solid black;\n}\n\n.Hb1sIsOVSFIUDewsZfrek{\n  padding : 2.5px;\n}\n\n._1v_h2MLyXT1k89Ao937PB3{\n  flex : 5;\n  text-align : left;\n}\n\n._3pedXEK-IDzdCtTgAvxyrr{\n  flex : 2;\n  text-align : right;\n}\n\n._1wiRXQOlQWFhlZSeSzIuwW{\n  font-size : 20px;\n}\n\n.T87t7iNiOQb3eK8OQX8sb{\n  font-size : 15px;\n}\n\n\n", ""]);

// exports
exports.locals = {
	"list": "_393qTOzdYL2xqGd_cghxEY",
	"flexContainer": "_3PUCRnSTaysfmk-3yWBWQi",
	"flexContainerLabel": "_2bWn3dC-FrkuDl4pw98GvI _3PUCRnSTaysfmk-3yWBWQi",
	"col": "Hb1sIsOVSFIUDewsZfrek",
	"track": "_1v_h2MLyXT1k89Ao937PB3 Hb1sIsOVSFIUDewsZfrek",
	"feature": "_3pedXEK-IDzdCtTgAvxyrr Hb1sIsOVSFIUDewsZfrek",
	"trackLabel": "_1wiRXQOlQWFhlZSeSzIuwW _1v_h2MLyXT1k89Ao937PB3 Hb1sIsOVSFIUDewsZfrek",
	"featureLabel": "T87t7iNiOQb3eK8OQX8sb _3pedXEK-IDzdCtTgAvxyrr Hb1sIsOVSFIUDewsZfrek"
};
...
exports.ArtistTitle = exports.SignIn = exports.Title = undefined;

var _react = __webpack_require__(2);

var _react2 = _interopRequireDefault(_react);

var _stateless = __webpack_require__(113);
...
var ArtistTitle = exports.ArtistTitle = function ArtistTitle(props) {
  var artist = props.artist;
  return _react2.default.createElement(
    'div',
    { className: _stateless2.default.container },
    _react2.default.createElement('img', {
      className: _stateless2.default.img,
      src: artist.images[2].url
    }),
    _react2.default.createElement(
      'div',
      { className: _stateless2.default.artist },
      artist.name
    ),
    _react2.default.createElement(
      'div',
      { className: _stateless2.default.genreContainer },
      artist.genres.map(function (genre, index) {
        return _react2.default.createElement(
          'div',
          {
            className: _stateless2.default.genre,
            key: index
          },
          genre
        );
...
if(false) {
	module.hot.accept("!!../../node_modules/css-loader/index.js??ref--1-1!./stateless.css", function() {
		var newContent = require("!!../../node_modules/css-loader/index.js??ref--1-1!./stateless.css");
...
// module
exports.push([module.i, "._-7gCOjMENV8xH2pfve_vP{\n  text-align: center;\n  font-size: 30px\n}\n\n._3CokE2H8tyEFtgOWoiznf-{\n  display: block;\n  margin-left: auto;\n  margin-right: auto;\n}\n\n._3mPH2SjbnQd1SD9PeXvNUC{\n\n  margin : auto;\n}\n\n._1fQDVNdN_P9wrRXqnZdi2y{\n  display : flex;\n  justify-content : space-between;\n}\n\n\n._3nDQrz4mJQJ8syaImC20J6{\n  font-size : 15px;\n  text-align: center;\n}", ""]);

// exports
exports.locals = {
	"artist": "_-7gCOjMENV8xH2pfve_vP",
	"img": "_3CokE2H8tyEFtgOWoiznf-",
	"container": "_3mPH2SjbnQd1SD9PeXvNUC",
	"genreContainer": "_1fQDVNdN_P9wrRXqnZdi2y",
	"genre": "_3nDQrz4mJQJ8syaImC20J6"
};
